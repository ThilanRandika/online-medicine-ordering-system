            ...
            <ul class="navLinks">
                ...
                <li class="navList active">
                    <a href="productDetailPage.jsp">
                        ...
                        <span class="links">Product Update</span>
                    </a>
                </li>
        ...
        <form action="update" method="post" enctype="multipart/form-data">
            <div class="product-details">
	               ...
	               <div class="product-info">
	              	<p><strong>Id:</strong> 
	                      <input type="text" name="productId" value="<%= ((Product) session.getAttribute("editProduct")).getProductId() %>" readonly>
	                  </p>
	                  <p><strong>Name:</strong>
	                      <input type="text" name="productName" value="<%= ((Product) session.getAttribute("editProduct")).getProductName() %>">
	                  </p>
	                  <p><strong>Category:</strong> 
	                      <input type="text" name="productCategory" value="<%= ((Product) session.getAttribute("editProduct")).getProduCategory() %>">
	                  </p>
	                  <p><strong>Description:</strong> 
	                      <textarea name="productDescription" rows="4" cols="50"><%= ((Product) session.getAttribute("editProduct")).getProductDescription() %></textarea>
	                  </p>
	                  <p><strong>Price:</strong> 
	                      <input type="text" name="productPrice" value="<%= ((Product) session.getAttribute("editProduct")).getProductPrice() %>">
	                  </p>
	                  <p><strong>Quantity:</strong> 
	                      <input type="text" name="productQuantity" value="<%= ((Product) session.getAttribute("editProduct")).getProductQuantity() %>">
	                  </p>
