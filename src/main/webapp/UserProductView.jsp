...
<body>
    ...
    <div class="container">
        ...
        <div class="product-info">
            <p><strong>Name:</strong> <%= ((Product) session.getAttribute("viewProduct")).getProductName() %></p>
            <p><strong>Category:</strong> <%= ((Product) session.getAttribute("viewProduct")).getProduCategory() %></p>
            <p><strong>Description:</strong> <%= ((Product) session.getAttribute("viewProduct")).getProductDescription() %></p>
            <p><strong>Price:</strong> Rs.<%= ((Product) session.getAttribute("viewProduct")).getProductPrice() %></p>
            <p><strong>Availability:</strong> In Stock</p>
            <div class="add-to-cart">
            	<form action="/addtocart"  method="post">
            		<input type="hidden" name="PId" value="<%= ((Product) session.getAttribute("viewProduct")).getProductId() %>">
